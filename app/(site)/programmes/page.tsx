...
export const metadata: Metadata = {
  title: "Programmes",
  description:
    "Les programmes de la Fondation Sarje : éducation, santé, accompagnement communautaire et aide d'urgence.",
};
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 md:px-6 md:py-20">
      ...
      <p className="mt-5 max-w-xl text-body text-muted">
        Quatre axes d&rsquo;action, pensés pour se compléter et accompagner
        chaque enfant dans la durée.
      </p>
