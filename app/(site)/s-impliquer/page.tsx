  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 md:px-6 md:py-20">
      ...
      <p className="mt-5 max-w-xl text-body text-muted">
        Il existe une façon de s&rsquo;impliquer adaptée à chacun. Écrivez-nous
        pour en discuter — nous répondons personnellement à chaque message.
      </p>
